           ...
           <div class="button-group">
             ...
             <el-dialog title="新增用户" :visible.sync="dialogFormVisible" style="text-align:left">
              ...
              <div slot="footer" class="dialog-footer">
                ...
                <el-button @click="emptyUser('addFormUser')" size="small">清除所有</el-button>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-button type="text" size="small" @click = 'updateUserList(scope.row)'>修改</el-button>
                |
                <el-button type="text" size="small" @click="cutUser(scope.row)">删除</el-button>
                |
                <el-button type="text" size="small" @click="showUserDetail(scope.row)">查看</el-button>
                |
                <el-button type="text" size="small" @click="bindUser(scope.row)">绑定角色</el-button>
              </template>
            </el-table-column>
          </el-table>
