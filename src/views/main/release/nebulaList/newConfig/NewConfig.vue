  ...
  <el-container>
    ...
    <el-dialog 
            ...
            :visible.sync="dialogVisible1" width="40%">   
             <el-form ref="ruleForm2" :model="ruleForm2" :rules="rules2" label-width="120px" style="padding:10px 10px;">
              ...
              <el-form-item style="text-align:right">
                ...
                <el-button type="primary" :loading="addLoading" @click="submitForm('ruleForm2')">确定</el-button>
              </el-form-item>
            </el-form>
          </el-dialog>
  </el-container>
...
export default {
  ...
  methods: {
    ...
    getMsgList () {
      ...
      qryMappingService(data).then(res => {
    ...
    getMsgDetail (row, index) {
      ...
      getMappingMessageService(data).then(res => {
