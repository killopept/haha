<template>
  <div class="pagePostManage">
    <el-container class="page-table">
        <!-- 一、新增按钮 -->
      <el-header>
        <el-button type="primary" class="el-icon-circle-plus-outline" size="small"  @click="addDialogFormVisible = true"> 新增岗位</el-button>
            ...
            <el-row :gutter="24">
              <el-col :span="12">
                <el-form-item label="岗位名称:"
                              prop="postName"
                              id="postName">
                  <el-input type="roleName"  placeholder="请输入岗位名称" v-model="postForm.postName" size="small"></el-input>
                </el-form-item>  
      ...
      <el-main>
        ...
        <el-dialog title="修改岗位" :visible.sync="updateDialogFormVisible">
            ...
            <el-row :gutter="24">
              <el-col :span="12">
                <el-form-item label="岗位名称:"  prop="postName"  id="postName">
                  <el-input type="text"  placeholder="请输入岗位名称" v-model="updatePostForm.postName" size="small"></el-input>
                </el-form-item>  
          ...
          <div slot="footer" class="dialog-footer">
            <el-button @click="updateDialogFormVisible = false">返回</el-button>
...
export default {
  ...
  methods: {
    ...
    deleteRow (row) {
      ...
      delPostList(this.updatePostForm).then(res => {
        if (res.data.body.errorCode === '0') {
          this.$message({
            type: 'success',
            message: '删除成功!'
    ...
    // 提交修改
    submitUpdate () {
      updatePostList(this.updatePostForm).then(res => {
        if (res.data.body.errorCode === '0') {
