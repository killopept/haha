<template>
  <div class="checkHistoryList">
     <el-container class="page-table">
      ...
      <!-- 二、岗位列表 -->
      <el-main>
        <el-table :data="checkHistoryList"  border  width= "100%">
          ...
          <el-table-column  prop="bsnName"  label="交易名称">
            <template slot-scope="scope">
              <el-button @click="dialogDetailsDataBtn(scope.row)" type="text" size="small">{{scope.row.bsnName}} </el-button>
            </template>
          </el-table-column>
      ...
      <el-footer>
        <el-pagination background
          ...
          :total="parseInt(pageTotalNumber)"></el-pagination>
      </el-footer>
    </el-container>
  </div>
</template>
