  ...
  <el-row :gutter="24">
      ...
      <div class="app-left-side">
        ...
        <div class="app-barnch-tree">
          <el-tree class="filter-tree" 
                  :data="roleListTree" v-loading="loading1" 
                  ref="tree2"
                  node-key="roleName"
                  :props="defaultProps"
    ...
    <el-col :span="19">
      ...
      <div class="app-narrow-table">
        <el-table  :data="roleMenuTable"  border  width="100%"  v-loading="loading2">
    ...
    deleteRole () {
      if (this.roleValidateForm.roleName !== '') {
        this.$confirm('确认删除角色？', '提示', {
          ...
          this.roleValidateForm.roleName = ''
          this.roleValidateForm.roleDesc = ''
          this.roleValidateForm.roleStatus = '1'
          this.roleValidateForm.roleComBox = []
        })
      } else {
        this.open('请选择一个角色')
      }
